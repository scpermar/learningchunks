...
# MODIFIED FILE HERE 11/22 2:10pm
...
resourcegroup_name = 'scp'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'scp'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'eastus'
...
# Here, we add an entry for first carsa with two pieces of data - the name, and the cost
#
...
car = Entity()
car.PartitionKey = 'carmodels'
car.RowKey = '001'
car.make = Detroit Motor Company
car.model = 'MiniVan'
car.year = 2017
car.color = white
car.cost = 30000
table_service.insert_entity('itemstable', car)
print('Created entry for MiniVan...')
...
car.cost = 22000
table_service.insert_entity('itemstable', car)
print('Created entry for Roadster...\n')
...
coffee = Entity()
coffee.PartitionKey = 'CoffeeBar'
coffee.RowKey = '005'
coffee.brand = Running Coyote 
coffee.flavor = Midnight Dark
coffee.size = Big Dog
coffee.cost = 6.50
table_service.insert_entity('itemstable', coffee)
print('Created entry for night eyes dark coffee...\n')
time.sleep(1)
...
coffee.RowKey = '006'
coffee.brand = Running Coyote 
coffee.flavor = Wild Pack
coffee.size = Regular Dog
coffee.cost = 4.50
table_service.insert_entity('itemstable', coffee)
print('Created entry for barking pack coffee...\n')
time.sleep(1)
